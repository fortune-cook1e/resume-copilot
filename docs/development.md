...
```bash
git clone https://github.com/fortune-cook1e/resume-copilot.git
cd resume-copilot
pnpm install
```
...
Use `.env.example` as a starting point. Set your own auth secret and AI provider credentials before using the corresponding features:
